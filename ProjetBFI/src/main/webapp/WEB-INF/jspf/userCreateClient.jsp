...
<head>
<title><spring:message code="entities.user.create.client.title" /></title>
				...
				<div class="form-row">
					<div class="form-group col">
						<form:label path="client.id">
							<spring:message code="entities.user.client" />
						</form:label>
						...
						<form:errors element="div" path="client.id"
							cssClass="invalid-feedback" />
					</div>

					<div class="form-group col">
						<form:label path="firstname">
							<spring:message code="entities.user.firstname" />
					...
					<div class="form-group col">
						<form:label path="lastname">
							<spring:message code="entities.user.lastname" />
							<span class="text-danger"><spring:message
									code="commons.symbols.required" /></span>
						</form:label>
				...
				<div class="form-row">
					...
					<div class="form-group col">
						<form:label path="email">
							<spring:message code="entities.user.email" />
							<span class="text-danger"><spring:message
									code="commons.symbols.required" /></span>
						</form:label>
						<div class="input-group">
							<div class="input-group-prepend">
								<div class="input-group-text">
									<spring:message code="commons.symbols.email" />
								</div>
							</div>
							<form:input path="email" maxlength="255" cssClass="form-control"
								cssErrorClass="form-control is-invalid" autocomplete="off"
								placeHolder="${emailPattern}" />
					...
					<div class="form-group col">
						...
						<form:select path="role" cssClass="form-control"
							cssErrorClass="form-control is-invalid">
							<form:options items="${rolesClient}" />
						</form:select>
