...
<body>
	...
	<div class="container-fluid">
		<section>
			...
			<h3 class="text-primary"><spring:message code="entities.demande.create.hello" />${client.nom}<spring:message code=", nous sommes le" /><fmt:formatDate value="${today}" pattern="dd/MM/yyyy"/></h3>
